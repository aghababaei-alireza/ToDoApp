...
urlpatterns = [
    ...
    path(
        "logout/", LogoutView.as_view(next_page="Account:login"), name="logout"
    ),
    path("signup/", CustomSignupView.as_view(), name="signup"),
    path(
        "change-password/",
        CustomeChangePasswordView.as_view(),
    ...
    path(
        ...
        VerificationRequiredView.as_view(),
